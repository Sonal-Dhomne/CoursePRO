...
<?php
$sql = "SELECT student.stu_id, student.stu_name, student.stu_email, GROUP_CONCAT(course.course_name SEPARATOR ', ') AS courses_taken
        FROM student
        LEFT JOIN student_course ON student.stu_id = student_course.stu_id
